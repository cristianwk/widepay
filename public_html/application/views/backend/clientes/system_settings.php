<?php echo form_open(base_url() . 'index.php?clinte/system_settings/do_update', array('class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top'));
?>
<div class="row">
    <div class="col-md-12">
        ...
        <div class="panel panel-primary" >
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label  class="col-sm-3 control-label"><?php echo get_phrase('url'); ?></label>
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="url" 
                               value="<?php echo $this->db->get_where('settings', array('type' => 'url'))->row()->description; ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="status" 
                               value="<?php echo $this->db->get_where('settings', array('type' => 'status'))->row()->description; ?>">
                    </div>
                </div>
